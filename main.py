...
convert_button = tk.Button(root, text="Convert", command=convert_altitude, font=custom_font)

# grid layout
label_altitude.grid(row=0, column=0, pady=10)
entry_altitude.grid(row=0, column=1, pady=10)
unit_input_dropdown.grid(row=1, column=0, pady=10)
unit_output_dropdown.grid(row=1, column=1, pady=10)
